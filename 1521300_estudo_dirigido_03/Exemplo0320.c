...
void method_20 (void)
{
    ...
    printf("Digite dois valores reais x e y, onde 0 < x < y < 1:\n");
    printf("Digite o valor de x: ");
    scanf("%lf", &x);
    printf("Digite o valor de y: ");
    scanf("%lf", &y);

    while (x <= 0 || x >= 1 || y <= 0 || y >= 1 || x >= y)
    {
        printf("Erro: x e y devem ser maiores que 0 e menores que 1, e x deve ser menor que y. Tente novamente.\n");
        printf("Digite o valor de x: ");
        scanf("%lf", &x);
        printf("Digite o valor de y: ");
        scanf("%lf", &y);
    ...
    for (int i = 0; i < n; i++) {
        ...
        if (parte_fracionaria < x || parte_fracionaria > y) {
            count++;

        }
    }

    printf("Total de valores com parte fracionaria fora do intervalo (%.2lf:%.2lf): %d\n", x, y, count);
...
int main ( )
{
 ...
 do
 {
     ...
     printf("\n20 - repeticao com teste no inicio");
     printf("");
